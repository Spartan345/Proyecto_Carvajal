...
$message='';
  ...
  {
    $stmt = $con->prepare('INSERT INTO `login`(`usuario`, `clave`, `correo`, `documento`, `nombre`, `apellido`) VALUES (:usu,:pass,:correo,:doc,:nombre,:apellido)');
            ...
            <div class="card-body">
              <form action="../controladores/inicio_sesion.php" method="post">
                ...
                <div align="text-center" class="form-group">
                 <a href="../controladores/inscribirse.php">Registro</a>
                </div>
                <div align="text-center" class="form-group">
                 <a href="admin.php">Ingreso Administrativo</a>
                </div>
                <div align="text-center" class="form-group">
                 <a href="Fun.php">Ingreso Funcionario</a>
                </div>
              </form>
            </div>
          </div>
